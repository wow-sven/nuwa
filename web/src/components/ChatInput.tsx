...
export function ChatInput({
  ...
  const handleAITrigger = () => {
    ...
    const newValue =
      localValue.trim() === ""
        ? "/ai "
        : localValue.toLowerCase().startsWith("/ai") ||
            localValue.includes("@AI")
          ? localValue
    ...
    <div className="w-full flex flex-col items-center">
      {showWarning && (
        <div className="w-full mb-2">
          <Callout.Root color="orange" className="w-full flex">
            <Callout.Icon>
              <InfoCircledIcon />
            </Callout.Icon>
            <Callout.Text className="w-full">
              <div className="w-full flex items-center justify-between gap-1">
                This is an on-chain AI chat. All messages are public and
                permanently stored on the blockchain. <br />
                Please do not share any private or sensitive information.
                <Cross2Icon
                  onClick={() => setShowWarning(false)}
                  className="h-5 w-5 cursor-pointer mb-auto hover:text-red-800"
                />
              </div>
            </Callout.Text>
          </Callout.Root>
      ...
      <div className="relative w-full flex flex-col justify-center">
        {paymentMode && (
          <div className="w-full mb-2 p-2 bg-blue-50 border border-blue-200 rounded-lg flex items-center">
            ...
            <span className="text-blue-600 text-xs ml-2">
              RGas will be sent with your message
            </span>
            <button
