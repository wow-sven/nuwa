  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (agentResult.execution_info.status.type !== "executed") {
        ...
        throw new Error(
          `Agent creation failed: ${JSON.stringify(agentResult.execution_info.status)}`
        );
      }
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Username must be 4-16 characters long, contain only letters,
              numbers, and underscores, and cannot be all numbers.
            </p>
          </div>
