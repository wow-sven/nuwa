...
export const IntegrationsBlock = () => (
  <Block className="col-span-3 flex flex-col overflow-hidden md:col-span-2">
    <div className="flex-1 flex items-center justify-center">
      <CardTitle>Integrate with Web3 Protocols Across All Chains</CardTitle>
    </div>

    <div className="relative -mx-6 -mb-6 mt-auto grid grid-cols-3 place-content-center rounded-t-none border-t-2 border-zinc-900">
