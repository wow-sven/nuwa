...
- **APIs** and **protocol-based access layers** can expose service functionality.
...
- **Nuwa Agent Runtime**: Personalized agent with memory, reasoning, and execution capacity.
- **Input Interface (UX)**: Natural language-first interface (text/voice/AR) as the universal input bar.
