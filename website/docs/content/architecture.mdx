...
Nuwa Client provides a reference implmentation on accessing caps. In addition it has built-in memory management, cryptographic based identity management and wallet management.
