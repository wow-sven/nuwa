...
import { useUpdateAgentTemperature } from "../../hooks/use-agent-temperature-update";
import { useAgentTemperature } from "../../hooks/use-agent-temperature";
...
export function AgentTemperaturePanel() {
    ...
    const { data: fetchedTemperature, refetch: refetchTemperature, isLoading } = useAgentTemperature(agent?.id);
                ...
                <div className="space-y-4">
                    {isEditingTemperature ? (
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Controls randomness: Lower values are more focused and deterministic, higher values allow more creativity.
                            </p>
                        </div>
                    )}
                </div>
