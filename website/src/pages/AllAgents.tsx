...
export const AllAgents = () => {
    ...
    const [lastCursor, setLastCursor] = useState<IndexerStateIDView | undefined>(undefined)
    ...
    useMemo(() => {
        if (agents.length > 0) {
            ...
            const existingAddresses = new Set(allAgents.map(agent => agent.agent_address))
            const newAgents = agents.filter(agent => !existingAddresses.has(agent.agent_address))
