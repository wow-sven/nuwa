...
export function AgentChat() {
  ...
  return (
    <>
      <SEO
        title={'AGENT NAME'} //TODO: replace with agent name
        description={'AGENT DESCRIPTION'} //TODO: replace with agent description
        keywords={`AGENT NAME, AI Chat, Web3 AI, Autonomous Agent, Crypto Agent, Blockchain AI, Nuwa Chat`}
        ogUrl={'AGENT AVATAR'} // TODO: replace with agent avatar
      />
